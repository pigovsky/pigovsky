...
Programmiersprachen \& Technologien & Scala (Akka HTTP/Pekko, Specs2, Mockito, Play Framework, sbt); Python (FastAPI, Django, Celery); Java, Kotlin (Spring Boot, Android SDK, JUnit, Gradle, MVN); Bash \\[5pt]
...
\begin{itemize}
  ...
  \item Konsultieren Telekommunikation Operatoren; Implementierung von Features und Fixes für Ihre Business Support Solutions
